...
public class sat extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.viewability_fragment_sat,container,false);

        mLayout = (LinearLayout) view.findViewById(R.id.containersat);

        NotificationViewabilityDbHelper pra = new NotificationViewabilityDbHelper(getActivity());

        ArrayList<String> ansArry = pra.display_probFinal(TbNames.PROBABILITYQUERYSAT_TABLE);
