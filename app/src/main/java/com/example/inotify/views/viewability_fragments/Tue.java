...
public class Tue extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.viewability_fragment_tue,container,false);

        mLayout = (LinearLayout) view.findViewById(R.id.containertue);

        NotificationViewabilityDbHelper pra = new NotificationViewabilityDbHelper(getActivity());

        ArrayList<String> ansArry = pra.display_probFinal(TbNames.PROBABILITYQUERYTUE_TABLE);
