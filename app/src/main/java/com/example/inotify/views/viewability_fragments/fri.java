...
public class fri extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.viewability_fragment_fri,container,false);

        mLayout = (LinearLayout) view.findViewById(R.id.containerfri);

        NotificationViewabilityDbHelper pra = new NotificationViewabilityDbHelper(getActivity());

        ArrayList<String> ansArry = pra.display_probFinal(TbNames.PROBABILITYQUERYFRI_TABLE);
