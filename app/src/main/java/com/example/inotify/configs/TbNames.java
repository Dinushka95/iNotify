...
public class TbNames {
    ...
    public static final String CONTACTCOUNT_TABLE = "contactcount_table";
    public static final String SCREENTIME_TABLE = "screentime_table";
    public static final String CALLDURATION_TABLE = "callduration_table";
