...
public class MyLocationUpdatesComponent {

    private static final String TAG = MyLocationUpdatesComponent.class.getSimpleName();
    ...
    public MyLocationUpdatesComponent(ILocationProvider iLocationProvider) {
