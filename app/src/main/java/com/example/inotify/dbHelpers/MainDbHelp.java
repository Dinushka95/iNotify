...
public class MainDbHelp extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TbNames.SCREENSTATUS_TABLE + " (SCREENSTATUS_ID INTEGER PRIMARY KEY AUTOINCREMENT,NOTIFICATIONID TEXT,DATE TEXT,TIMEON TEXT,TIMEOFF TEXT)");
