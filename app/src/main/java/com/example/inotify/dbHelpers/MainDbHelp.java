...
public class MainDbHelp extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TbNames.SCREENOFF_TABLE + " (SCREENOFF_ID INTEGER PRIMARY KEY AUTOINCREMENT,NOTIFICATIONID TEXT,DATE TEXT,TIMEOFF TEXT)");
        db.execSQL("create table " + TbNames.SCREENON_TABLE + " (SCREENON_ID INTEGER PRIMARY KEY AUTOINCREMENT,NOTIFICATIONID TEXT,DATE TEXT,TIMEON TEXT)");
